...
import { APIPromise } from '@stainless-commons/spotify/core/api-promise';
...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    beforeEach(() => {
      process.env = { ...env };
      process.env['SPOTIFY_LOG'] = undefined;
    });
    ...
    const forceAPIResponseForClient = async (client: Spotify) => {
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['SPOTIFY_BASE_URL'] = undefined;
    });
  ...
  test('maxRetries option is correctly set', () => {
    ...
    // default
    const client2 = new Spotify({ clientID: 'My Client ID', clientSecret: 'My Client Secret' });
