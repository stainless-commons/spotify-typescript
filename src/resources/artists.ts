...
export class Artists extends APIResource {
   ...
   * Spotify ID.
   */
  retrieve(id: string, options?: RequestOptions): APIPromise<ArtistRetrieveResponse> {
  ...
  ): APIPromise<ArtistListAlbumsResponse> {
    return this._client.get(path`/artists/${id}/albums`, { query, ...options });
  }
...
export interface ArtistRetrieveResponse {
  /**
   ...
   */
  external_urls?: ArtistRetrieveResponse.ExternalURLs;

  /**
   * Information about the followers of the artist.
   */
  followers?: ArtistRetrieveResponse.Followers;
   ...
   */
  images?: Array<ArtistRetrieveResponse.Image>;
...
export namespace ArtistRetrieveResponse {
  /**
   * Known external URLs for this artist.
   */
...
export interface ArtistListResponse {
  artists: Array<ArtistListResponse.Artist>;
}

export namespace ArtistListResponse {
...
export interface ArtistListAlbumsResponse {
  ...
  items: Array<ArtistListAlbumsResponse.Item>;
...
export namespace ArtistListAlbumsResponse {
...
export interface ArtistListRelatedArtistsResponse {
  artists: Array<ArtistListRelatedArtistsResponse.Artist>;
}

export namespace ArtistListRelatedArtistsResponse {
  export interface Artist {
    /**
     * The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the
     * artist.
...
export interface ArtistListTopTracksResponse {
  tracks: Array<ArtistListTopTracksResponse.Track>;
}

export namespace ArtistListTopTracksResponse {
