...
import {
  ...
  Followers as FollowersAPIFollowers,
} from './followers';
import * as ImagesAPI from './images';
import { ImageRetrieveResponse, ImageUpdateParams, Images } from './images';
...
export interface PlaylistRetrieveResponse {
   ...
   */
  external_urls?: PlaylistRetrieveResponse.ExternalURLs;
   ...
   */
  images?: Array<PlaylistRetrieveResponse.Image>;
...
Playlists.Followers = FollowersAPIFollowers;
...
export declare namespace Playlists {
  ...
  export {
    FollowersAPIFollowers as Followers,
